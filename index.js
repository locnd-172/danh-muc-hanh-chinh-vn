...
const parseJson = () => {
    ...
    sheet_name_list.forEach(function (y) {
        ...
        data.map(item => {
            ...
            if (provinces.findIndex(x => x.id === provinceId) < 0) {
                provinces.push({
                    id: provinceId,
                    name: provinceName
                })
        ...
        fs.writeFile("all_data.json", JSON.stringify(all), null, () => {
            console.log("parse all_data json success")
        })
        fs.writeFile("provinces_data.json", JSON.stringify(provinces), null, () => {
            console.log("parse provinces_data json success")
        })
    });
}
